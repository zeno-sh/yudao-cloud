...
/**
 * Ozon广告同步任务导出 Request VO
 *
 * @author Jax
 */
@Schema(description = "管理后台 - Ozon广告同步任务导出 Request VO")
@Data
public class OzonAdSyncTaskExportReqVO {
    ...
    @Schema(description = "报告UUID", example = "uuid-123")
