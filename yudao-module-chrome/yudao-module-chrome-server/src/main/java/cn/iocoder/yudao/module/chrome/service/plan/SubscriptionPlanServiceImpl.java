...
public class SubscriptionPlanServiceImpl implements SubscriptionPlanService {
    ...
    public Long createSubscriptionPlan(SubscriptionPlanSaveReqVO createReqVO) {
        // 校验订阅时长：非一次性购买时，订阅时长必须填写
        validateDurationDays(createReqVO.getBillingCycle(), createReqVO.getDurationDays());
        // 插入
    ...
    public void updateSubscriptionPlan(SubscriptionPlanSaveReqVO updateReqVO) {
        ...
        // 校验订阅时长：非一次性购买时，订阅时长必须填写
        validateDurationDays(updateReqVO.getBillingCycle(), updateReqVO.getDurationDays());
        // 更新
     ...
     * @param durationDays 订阅时长
     */
    private void validateDurationDays(Integer billingCycle, Integer durationDays) {
        // 一次性购买时，不需要校验订阅时长
        ...
        if (durationDays == null) {
            throw exception(SUBSCRIPTION_PLAN_DURATION_REQUIRED);
        }
    }
